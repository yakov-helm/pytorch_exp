...
class Module:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if self.call_super_init is False and bool(args):
            raise TypeError(
                "{}.__init__() takes 1 positional argument but {} were"
    ...
    def add_module(self, name: str, module: Optional["Module"]) -> None:
        ...
        if not isinstance(module, Module) and module is not None:
            raise TypeError(
                "{} is not a Module subclass".format(torch.typename(module))
            )
        elif not isinstance(name, str):
            raise TypeError(
                "module name should be a string. Got {}".format(torch.typename(name))
            )
    ...
    def register_forward_hook(
        ...
        *,
        ...
        """
        handle = hooks.RemovableHandle(
            self._forward_hooks, extra_dict=self._forward_hooks_with_kwargs
        )
