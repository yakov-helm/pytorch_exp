...
CUDA_INCLUDE_MAP = collections.OrderedDict(
    [
        ...
        (
            "cublas.h",
            (
                "rocblas.h" if rocm_version < (5, 2, 0) else "rocblas/rocblas.h",
                CONV_INCLUDE_CUDA_MAIN_H,
                API_BLAS,
            ),
        ),
        ...
        (
            "cusparse.h",
            (
                "hipsparse.h" if rocm_version < (5, 2, 0) else "hipsparse/hipsparse.h",
                CONV_INCLUDE,
                API_RAND,
            ),
        ),
        (
            "cufft.h",
            (
                "hipfft.h" if rocm_version < (5, 2, 0) else "hipfft/hipfft.h",
                CONV_INCLUDE,
                API_BLAS,
            ),
        ),
        (
            "cufftXt.h",
            (
                "hipfftXt.h" if rocm_version < (5, 2, 0) else "hipfft/hipfftXt.h",
                CONV_INCLUDE,
                API_BLAS,
            ),
        ),
        ...
        (
            "<nccl.h>",
            (
                "<rccl.h>" if rocm_version < (5, 2, 0) else "<rccl/rccl.h>",
                CONV_INCLUDE,
                API_RUNTIME,
            ),
        ),
...
CUDA_SPARSE_MAP = collections.OrderedDict(
    [
        ...
        (
            ...
            ("HIPSPARSE_DIAG_TYPE_UNIT", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_DIAG_TYPE_NON_UNIT",
            ("HIPSPARSE_DIAG_TYPE_NON_UNIT", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "cusparseSetMatDiagType",
            ("hipsparseSetMatDiagType", CONV_MATH_FUNC, API_SPARSE),
        ),
        ("cusparseFillMode_t", ("hipsparseFillMode_t", CONV_TYPE, API_SPARSE)),
        (
            "CUSPARSE_FILL_MODE_UPPER",
            ("HIPSPARSE_FILL_MODE_UPPER", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_FILL_MODE_LOWER",
            ("HIPSPARSE_FILL_MODE_LOWER", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "cusparseSetMatFillMode",
            ("hipsparseSetMatFillMode", CONV_MATH_FUNC, API_SPARSE),
        ),
        ("cusparseDirection_t", ("hipsparseDirection_t", CONV_TYPE, API_SPARSE)),
        (
            "CUSPARSE_DIRECTION_ROW",
            ("HIPSPARSE_DIRECTION_ROW", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_DIRECTION_COLUMN",
            ("HIPSPARSE_DIRECTION_COLUMN", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        ("cusparseSolvePolicy_t", ("hipsparseSolvePolicy_t", CONV_TYPE, API_SPARSE)),
        (
            "CUSPARSE_SOLVE_POLICY_NO_LEVEL",
            ("HIPSPARSE_SOLVE_POLICY_NO_LEVEL", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_SOLVE_POLICY_USE_LEVEL",
            ("HIPSPARSE_SOLVE_POLICY_USE_LEVEL", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "cusparseCreateBsrsv2Info",
            ("hipsparseCreateBsrsv2Info", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseCreateBsrsm2Info",
            ("hipsparseCreateBsrsm2Info", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDestroyBsrsv2Info",
            ("hipsparseDestroyBsrsv2Info", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDestroyBsrsm2Info",
            ("hipsparseDestroyBsrsm2Info", CONV_MATH_FUNC, API_SPARSE),
        ),
        ...
        (
            ...
            ("hipsparseSbsrsv2_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDbsrsv2_bufferSize",
            ("hipsparseDbsrsv2_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseCbsrsv2_bufferSize",
            ("hipsparseCbsrsv2_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseZbsrsv2_bufferSize",
            ("hipsparseZbsrsv2_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseSbsrsv2_analysis",
            ("hipsparseSbsrsv2_analysis", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDbsrsv2_analysis",
            ("hipsparseDbsrsv2_analysis", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseCbsrsv2_analysis",
            ("hipsparseCbsrsv2_analysis", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseZbsrsv2_analysis",
            ("hipsparseZbsrsv2_analysis", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseSbsrsv2_solve",
            ("hipsparseSbsrsv2_solve", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDbsrsv2_solve",
            ("hipsparseDbsrsv2_solve", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseCbsrsv2_solve",
            ("hipsparseCbsrsv2_solve", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseZbsrsv2_solve",
            ("hipsparseZbsrsv2_solve", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseSbsrsm2_bufferSize",
            ("hipsparseSbsrsm2_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDbsrsm2_bufferSize",
            ("hipsparseDbsrsm2_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseCbsrsm2_bufferSize",
            ("hipsparseCbsrsm2_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseZbsrsm2_bufferSize",
            ("hipsparseZbsrsm2_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseSbsrsm2_analysis",
            ("hipsparseSbsrsm2_analysis", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDbsrsm2_analysis",
            ("hipsparseDbsrsm2_analysis", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseCbsrsm2_analysis",
            ("hipsparseCbsrsm2_analysis", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseZbsrsm2_analysis",
            ("hipsparseZbsrsm2_analysis", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseSbsrsm2_solve",
            ("hipsparseSbsrsm2_solve", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDbsrsm2_solve",
            ("hipsparseDbsrsm2_solve", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseCbsrsm2_solve",
            ("hipsparseCbsrsm2_solve", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseZbsrsm2_solve",
            ("hipsparseZbsrsm2_solve", CONV_MATH_FUNC, API_SPARSE),
        ),
        ...
        (
            ...
            ("hipsparseCreateCsrgemm2Info", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
        ...
        (
            ...
            ("hipsparseDcsrgemm2_bufferSizeExt", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseScsrgemm2_bufferSizeExt",
            ("hipsparseScsrgemm2_bufferSizeExt", CONV_MATH_FUNC, API_SPARSE),
        ),
        ...
        (
            ...
            ("hipsparseSetPointerMode", CONV_MATH_FUNC, API_SPARSE),
        ),
        ("cusparseXcsrgeam2Nnz", ("hipsparseXcsrgeam2Nnz", CONV_MATH_FUNC, API_SPARSE)),
        (
            "cusparseScsrgeam2_bufferSizeExt",
            ("hipsparseScsrgeam2_bufferSizeExt", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDcsrgeam2_bufferSizeExt",
            ("hipsparseDcsrgeam2_bufferSizeExt", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseCcsrgeam2_bufferSizeExt",
            ("hipsparseCcsrgeam2_bufferSizeExt", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseZcsrgeam2_bufferSizeExt",
            ("hipsparseZcsrgeam2_bufferSizeExt", CONV_MATH_FUNC, API_SPARSE),
        ),
        ...
        (
            ...
            ("hipsparseXbsrsm2_zeroPivot", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseXbsrsv2_zeroPivot",
            ("hipsparseXbsrsv2_zeroPivot", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
        ...
        (
            ...
            ("hipsparseSpMV_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        ("cusparseSpMM", ("hipsparseSpMM", CONV_MATH_FUNC, API_SPARSE)),
        (
            "cusparseSpMM_bufferSize",
            ("hipsparseSpMM_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        ("cusparseCreateDnMat", ("hipsparseCreateDnMat", CONV_MATH_FUNC, API_SPARSE)),
        (
            "cusparseDnMatSetStridedBatch",
            ("hipsparseDnMatSetStridedBatch", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseCsrSetStridedBatch",
            ("hipsparseCsrSetStridedBatch", CONV_MATH_FUNC, API_SPARSE),
        ),
        ...
        (
            ...
            ("hipsparseSpGEMM_destroyDescr", CONV_MATH_FUNC, API_SPARSE),
        ),
        ("cusparseCreateCoo", ("hipsparseCreateCoo", CONV_MATH_FUNC, API_SPARSE)),
        ("cusparseCreateCsr", ("hipsparseCreateCsr", CONV_MATH_FUNC, API_SPARSE)),
        (
            "cusparseSpGEMM_createDescr",
            ("hipsparseSpGEMM_createDescr", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseDnMatSetStridedBatch",
            ("hipsparseDnMatSetStridedBatch", CONV_MATH_FUNC, API_SPARSE),
        ...
        (
            ...
            ("hipsparseSDDMM_bufferSize", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseSDDMM_preprocess",
            ("hipsparseSDDMM_preprocess", CONV_MATH_FUNC, API_SPARSE),
        ),
        ("cusparseSDDMM", ("hipsparseSDDMM", CONV_MATH_FUNC, API_SPARSE)),
        (
            "cusparseSpGEMM_compute",
            ("hipsparseSpGEMM_compute", CONV_MATH_FUNC, API_SPARSE),
        ),
        (
            "cusparseSpGEMM_workEstimation",
            ("hipsparseSpGEMM_workEstimation", CONV_MATH_FUNC, API_SPARSE),
        ),
        ("cusparseSpMatGetSize", ("hipsparseSpMatGetSize", CONV_MATH_FUNC, API_SPARSE)),
        (
            "cusparseCsrSetPointers",
            ("hipsparseCsrSetPointers", CONV_MATH_FUNC, API_SPARSE),
        ),
        ...
        (
            "CUSPARSE_INDEX_32I",
            ("HIPSPARSE_INDEX_32I", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_INDEX_64I",
            ("HIPSPARSE_INDEX_64I", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_ORDER_COL",
            ("HIPSPARSE_ORDER_COLUMN", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_MV_ALG_DEFAULT",
            ("HIPSPARSE_MV_ALG_DEFAULT", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_MM_ALG_DEFAULT",
            ("HIPSPARSE_MM_ALG_DEFAULT", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_SPMM_COO_ALG1",
            ("HIPSPARSE_SPMM_COO_ALG1", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_SPMM_COO_ALG2",
            ("HIPSPARSE_SPMM_COO_ALG2", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_COOMV_ALG",
            ("HIPSPARSE_COOMV_ALG", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_SPMM_CSR_ALG1",
            ("HIPSPARSE_CSRMM_ALG1", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_SPGEMM_DEFAULT",
            ("HIPSPARSE_SPGEMM_DEFAULT", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
            "CUSPARSE_SDDMM_ALG_DEFAULT",
            ("HIPSPARSE_SDDMM_ALG_DEFAULT", CONV_NUMERIC_LITERAL, API_SPARSE),
        ),
        (
