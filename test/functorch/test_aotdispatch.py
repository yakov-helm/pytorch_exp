...
def forward(self, arg0_1):
    ...
    def test_compilation_context(self, counter):
        ...
        out.sum().backward()
        self.assertEqual(
            count, [(["0_forward"], 4), (["1_inference"], 4), (["0_backward"], 8)]
        )
...
class TestAOTModuleSimplified(AOTTestCase):
 ...
 - Eq(s2, 30)""",
    ...
    def test_aot_module_simplified_fake_tensor_gm_raises(self):
        ...
        with self.assertRaisesRegex(AssertionError, "Unexpected fake buffer"):
...
symbolic_aot_autograd_failures = {
    ...
    xfail(
        "cumprod", ""
    ),  # aten.cumprod.default - couldn't find symbolic meta function/decomposition
    xfail(
        "cumulative_trapezoid", ""
    ),  # Cannot call sizes() on tensor with symbolic sizes/strides
    xfail(
        "diff", ""
    ),  # aten.zeros_like.default - couldn't find symbolic meta function/decomposition
    xfail(
        "digamma", ""
    ...
    xfail(
        "linalg.cholesky_ex", ""
    ),  # could not find kernel for aten.linalg_solve_triangular.default
    xfail(
        "linalg.cond", ""
    ...
    xfail(
        "linalg.det", ""
    ),  # aten._linalg_det.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.det", "singular"
    ),  # aten._linalg_det.default - couldn't find symbolic meta function/deco...
    xfail(
        "linalg.eigh", ""
    ),  # aten._linalg_eigh.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.eigvals", ""
    ),  # aten.linalg_eig.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.eigvalsh", ""
    ),  # aten._linalg_eigh.default - couldn't find symbolic meta function/decompo...
    xfail(
        "linalg.householder_product", ""
    ),  # aten.linalg_householder_product.default - couldn't find symbo...
    xfail(
        "linalg.lstsq", ""
    ...
    xfail(
        "linalg.lu_factor", ""
    ),  # aten.linalg_lu_factor_ex.default - couldn't find symbolic meta function...
    xfail(
        "linalg.lu_factor_ex", ""
    ),  # aten.linalg_lu_factor_ex.default - couldn't find symbolic meta funct...
    xfail(
        "linalg.lu_solve", ""
    ...
    xfail(
        "linalg.pinv", ""
    ),  # aten.linalg_pinv.atol_rtol_tensor - couldn't find symbolic meta function/dec...
    xfail(
        "linalg.pinv", "hermitian"
    ),  # aten.linalg_pinv.atol_rtol_tensor - couldn't find symbolic meta fu...
    xfail(
        "linalg.qr", ""
    ),  # aten.linalg_qr.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.slogdet", ""
    ),  # aten._linalg_slogdet.default - couldn't find symbolic meta function/decom...
    xfail(
        "linalg.solve", ""
    ),  # aten._linalg_solve_ex.default - couldn't find symbolic meta function/decomp...
    xfail(
        "linalg.solve_ex", ""
    ),  # aten._linalg_solve_ex.default - couldn't find symbolic meta function/dec...
    xfail(
        "linalg.solve_triangular", ""
    ),  # aten.linalg_solve_triangular.default - couldn't find symbolic me...
    xfail(
        "linalg.svd", ""
    ),  # Cannot call sizes() on tensor with symbolic sizes/strides
    xfail(
    ...
    xfail(
        "masked_select", ""
    ),  # aten.masked_select.default - couldn't find symbolic meta function/decompos...
    xfail(
        "matrix_exp", ""
    ),  # aten.linalg_matrix_exp.default - couldn't find symbolic meta function/decompo...
    xfail("median", ""),  # could not find kernel
    xfail("mode", ""),  # Cannot call sizes() on tensor with symbolic sizes/strides
    xfail(
        "nn.functional.adaptive_avg_pool3d", ""
    ),  # aten._adaptive_avg_pool3d_backward.default - couldn't ...
    xfail(
        "nn.functional.adaptive_max_pool1d", ""
    ),  # Cannot call sizes() on tensor with symbolic sizes/strides
    xfail(
        "nn.functional.adaptive_max_pool2d", ""
    ),  # aten.adaptive_max_pool2d.default - couldn't find symbo...
    xfail(
        "nn.functional.adaptive_max_pool3d", ""
    ),  # argument 'output_size' (position 2...
    xfail(
        "nn.functional.avg_pool3d", ""
    ),  # aten.avg_pool3d.default - couldn't find symbolic meta function/...
    skip(
    ...
    ),  # RuntimeError: aten.grid_sampler_3d.default - couldn't find sym ...
    xfail(
    ...
    ),  # Cannot call sizes() on tensor with symbolic sizes/st...
    xfail(
        "nn.functional.max_pool1d", ""
    ),  # Cannot call sizes() on tensor with symbolic sizes/strides
    xfail(
        "nn.functional.max_pool3d", ""
    ),  # aten.max_pool3d_with_indices.default - couldn't find symbolic m...
    xfail(
        "nn.functional.max_unpool1d", ""
    ),  # aten.max_unpool2d.default - couldn't find symbolic meta funct...
    xfail(
        "nn.functional.max_unpool1d", "grad"
    ),  # aten.max_unpool2d.default - couldn't find symbolic meta ...
    xfail(
    ...
    ),  # aten.max_unpool3d.default - couldn't find symbolic meta funct...
    xfail(
        "nn.functional.max_unpool3d", "grad"
    ),  # aten.max_unpool3d.default - couldn't find symbolic meta ...
    ...
    ),  # aten.reflection_pad1d.default - couldn't find symbolic meta fu...
    xfail(
        "nn.functional.pad", "replicate"
    ),  # aten.replication_pad1d.default - couldn't find symbolic meta...
    xfail("nn.functional.pdist", ""),  # could not find kernel
    xfail(
        "nn.functional.pixel_shuffle", ""
    ),  # aten.pixel_shuffle.default - couldn't find symbolic meta fun...
    xfail(
        "nn.functional.pixel_unshuffle", ""
    ),  # aten.pixel_unshuffle.default - couldn't find symbolic meta...
    xfail(
        "nn.functional.rrelu", ""
    ),  # aten.rrelu_with_noise.default - couldn't find symbolic meta function...
    ...
    xfail(
        "pinverse", ""
    ),  # aten.linalg_pinv.atol_rtol_tensor - couldn't find symbolic meta function/decomp...
    xfail("polar", ""),  # could not find kernel
    xfail(
        "polygamma", "polygamma_n_0"
    ),  # aten.polygamma.default - couldn't find symbolic meta function/de...
    xfail(
    ...
    xfail(
        "roll", ""
    ),  # narrow() received an invalid combination of arguments - got (FakeTensor, int, torch._C...
    xfail(
    ...
    ),  # aten.polygamma.default - couldn't find symbolic ...
    ...
    xfail(
        "triangular_solve", ""
    ),  # aten.triangular_solve.default - couldn't find symbolic meta function/de...
    xfail(
...
def _test_aot_autograd_module_helper(
    ...
    for module_input in module_inputs:
        ...
        _test_aot_autograd_forwards_backwards_helper(
            self, f, compiled_f, params_buffers_args
        )
