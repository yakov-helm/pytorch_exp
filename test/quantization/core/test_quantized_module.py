...
class TestStaticQuantizedModule(QuantizationTestCase):
    ...
    def test_prelu(self):
        ...
        # num_parameters = 1
        prelu_module = nnq.PReLU(
            output_scale=1.0, output_zero_point=0, num_parameters=1
        )
        ...
        self.assertEqual(qy_ref, qy, msg="PReLU module API failed")

        # num_parameters = num_channels
        prelu_module = nnq.PReLU(
            output_scale=1.0, output_zero_point=0, num_parameters=4
        )
