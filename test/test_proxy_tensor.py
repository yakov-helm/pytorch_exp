...
def show_guards(gm):
    ...
    return "\n".join(
        gm.shape_env.produce_guards(
            fx_placeholder_vals(gm), names, _simplified=True, constraint_inputs=None
        )
    )
...
def forward(self, a_1):
    ...
    def test_cat(self):
        ...
        self.assertExpectedInline(
            show_guards(gm), """2*L['a'].size()[1]*L['b'].size()[0] > 20"""
        )
    ...
    def test_size_with_tensor(self):
        ...
        self.assertRaisesRegex(
            RuntimeError,
            "data-dependent",
            lambda: make_fx(f, tracing_mode="symbolic")(a),
        )
...
symbolic_tensor_failures = {
    ...
    xfail(
        "cholesky_solve", ""
    ),  # Could not run 'aten::_cholesky_solve_helper' with arguments from the 'Meta' back...
    xfail("column_stack", ""),  # Tensors of type TensorImpl do not have numel
    xfail("combinations", ""),
    xfail(
        "count_nonzero", ""
    ),  # Could not run 'aten::count_nonzero.dim_IntList' with arguments from the 'Meta' ba...
    xfail(
        "cross", ""
    ),  # aten.linalg_cross.default - couldn't find symbolic meta function/decomposition
    xfail(
        "cumulative_trapezoid", ""
    ),  # aten.slice.Tensor - couldn't find symbolic meta function/decomposition
    xfail(
        "diff", ""
    ),  # aten.empty_like.default - couldn't find symbolic meta function/decomposition
    xfail(
        "dsplit", ""
    ),  # aten.slice.Tensor - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "fft.hfft", ""
    ),  # aten._to_copy.default - couldn't find symbolic meta function/decomposition
    xfail(
        "fft.hfftn", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "frexp", ""
    ),  # aten.frexp.Tensor - couldn't find symbolic meta function/decomposition
    xfail(
        "geqrf", ""
    ...
    xfail(
        "histc", ""
    ),  # Could not run 'aten::histc' with arguments from the 'Meta' backend. This could be because...
    xfail(
        "histogram", ""
    ...
    xfail(
        "isin", ""
    ),  # aten.isin.Tensor_Tensor - couldn't find symbolic meta function/decomposition
    xfail(
        "kron", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
        "kthvalue", ""
    ),  # aten.kthvalue.default - couldn't find symbolic meta function/decomposition
    ...
    xfail(
        "linalg.eigh", ""
    ),  # aten._linalg_eigh.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.eigvalsh", ""
    ),  # aten._linalg_eigh.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.householder_product", ""
    ),  # aten.linalg_householder_product.default - couldn't find symbolic meta funct...
    xfail(
        "linalg.ldl_factor", ""
    ),  # aten.linalg_ldl_factor_ex.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.ldl_factor_ex", ""
    ),  # aten.linalg_ldl_factor_ex.default - couldn't find symbolic meta function/decompos...
    xfail(
        "linalg.ldl_solve", ""
    ),  # aten.linalg_ldl_solve.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.lu", ""
    ),  # aten.linalg_lu.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.lu_factor", ""
    ),  # aten.linalg_lu_factor_ex.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.lu_factor_ex", ""
    ),  # aten.linalg_lu_factor_ex.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.lu_solve", ""
    ),  # aten.linalg_lu_solve.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.matrix_power"
    ),  # RuntimeError: Trying to call aten.size on a tensor with symbolic shape
    xfail(
        "linalg.matrix_rank", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "linalg.pinv", ""
    ),  # aten.linalg_pinv.atol_rtol_tensor - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.pinv", "singular"
    ),  # aten.linalg_cholesky_ex.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.pinv", "hermitian"
    ),  # aten.linalg_pinv.atol_rtol_tensor - couldn't find symbolic meta function/decompo...
    xfail(
        "linalg.qr", ""
    ),  # aten.linalg_qr.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.slogdet", ""
    ),  # aten._linalg_slogdet.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.solve", ""
    ),  # aten._linalg_solve_ex.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.solve_ex", ""
    ),  # aten._linalg_solve_ex.default - couldn't find symbolic meta function/decomposition
    xfail(
        "linalg.solve_triangular", ""
    ),  # aten.linalg_solve_triangular.default - couldn't find symbolic meta function/de...
    xfail(
        "linalg.tensorinv", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "logaddexp2", ""
    ),  # aten.logaddexp2.default - couldn't find symbolic meta function/decomposition
    xfail(
        "logdet", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "lu_unpack", ""
    ),  # aten.lu_unpack.default - couldn't find symbolic meta function/decomposition
    xfail(
        "masked_select", ""
    ),  # aten.masked_select.default - couldn't find symbolic meta function/decomposition
    xfail(
        "matrix_exp", ""
    ),  # aten.linalg_matrix_exp.default - couldn't find symbolic meta function/decomposition
    xfail(
        "median", ""
    ),  # Could not run 'aten::median' with arguments from the 'Meta' backend. This could be becau...
    xfail(
        "mode", ""
    ),  # aten.mode.default - couldn't find symbolic meta function/decomposition
    xfail(
        "nanquantile", ""
    ...
    ),  # aten.adaptive_max_pool2d.default - couldn't find symbolic meta funct...
    xfail(
        "nn.functional.adaptive_max_pool3d", ""
    ),  # argument 'output_size' (position 2) must be tupl...
    xfail(
        "nn.functional.avg_pool3d", ""
    ),  # aten.avg_pool3d.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    ),  # aten._embedding_bag_forward_only.default - couldn't find symbolic meta fun...
    xfail(
        "nn.functional.fractional_max_pool2d", ""
    ),  # argument 'size' must be tuple of ints, but found element of t...
    xfail(
        "nn.functional.fractional_max_pool3d", ""
    ),  # argument 'size' must be tuple of ints, but found element of t...
    xfail(
        "nn.functional.grid_sample", ""
    ),  # aten.grid_sampler_2d.default - couldn't find symbolic meta function/decompos...
    xfail(
        "nn.functional.interpolate", "linear"
    ),  # aten.upsample_linear1d.vec - couldn't find symbolic meta function/dec...
    xfail(
        "nn.functional.interpolate", "trilinear"
    ),  # aten.upsample_trilinear3d.vec - couldn't find symbolic meta functi...
    xfail(
        "nn.functional.max_pool1d", ""
    ),  # Trying to call aten.size on a tensor with symbolic shapes.
    xfail(
        "nn.functional.max_pool3d", ""
    ),  # aten.max_pool3d_with_indices.default - couldn't find symbolic meta function/d...
    xfail(
        "nn.functional.max_unpool1d", "grad"
    ),  # aten.max_unpool2d.default - couldn't find symbolic meta function/decom...
    xfail(
        "nn.functional.max_unpool2d", "grad"
    ),  # aten.max_unpool2d.default - couldn't find symbolic meta function/decom...
    xfail(
        "nn.functional.max_unpool3d", "grad"
    ),  # aten.max_unpool3d.default - couldn't find symbolic meta function/decom...
    xfail(
        "nn.functional.multi_margin_loss", ""
    ),  # Could not run 'aten::multi_margin_loss' with arguments from the...
    xfail(
        "nn.functional.multilabel_margin_loss", ""
    ),  # Could not run 'aten::multilabel_margin_loss_forward' with ...
    xfail(
        "nn.functional.pad", "reflect"
    ),  # aten.reflection_pad1d.default - couldn't find symbolic meta function/decompo...
    xfail(
        "nn.functional.pad", "replicate"
    ),  # aten.replication_pad1d.default - couldn't find symbolic meta function/deco...
    xfail(
        "nn.functional.pdist", ""
    ),  # Could not run 'aten::_pdist_forward' with arguments from the 'Meta' backend...
    xfail(
        "nn.functional.pixel_unshuffle", ""
    ),  # aten.pixel_unshuffle.default - couldn't find symbolic meta function/deco...
    xfail(
        "nn.functional.smooth_l1_loss", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
        "normal", "number_mean"
    ),  # aten.normal.float_Tensor - couldn't find symbolic meta function/decomposition
    xfail(
        "ormqr", ""
    ),  # aten.ormqr.default - couldn't find symbolic meta function/decomposition
    xfail(
        "pca_lowrank", ""
    ),  # aten.mm.default - couldn't find symbolic meta function/decomposition
    xfail(
        "pinverse", ""
    ),  # aten.linalg_pinv.atol_rtol_tensor - couldn't find symbolic meta function/decomposition
    xfail(
        "polygamma", "polygamma_n_0"
    ),  # aten.polygamma.default - couldn't find symbolic meta function/decomposition
    xfail(
    ...
    xfail(
        "renorm", ""
    ),  # aten.renorm.default - couldn't find symbolic meta function/decomposition
    xfail(
        "repeat_interleave", ""
    ),  # Cannot call sizes() on tensor with symbolic sizes/strides
    xfail(
        "resize_", ""
    ),  # aten.clone.default - couldn't find symbolic meta function/decomposition
    xfail(
        "resize_as_", ""
    ),  # aten.clone.default - couldn't find symbolic meta function/decomposition
    ...
    xfail(
        "searchsorted", ""
    ),  # Could not run 'aten::searchsorted.Tensor' with arguments from the 'Meta' backend. ...
    xfail(
        "_segment_reduce", "offsets"
    ),  # aten.segment_reduce.default - couldn't find symbolic meta function/decomposition
    xfail(
        "special.airy_ai", ""
    ),  # aten.special_airy_ai.default - couldn't find symbolic meta function/decomposition
    xfail(
        "special.bessel_y0", ""
    ),  # aten.special_bessel_y0.default - couldn't find symbolic meta function/decomposition
    xfail(
        "special.bessel_y1", ""
    ),  # aten.special_bessel_y1.default - couldn't find symbolic meta function/decomposition
    xfail(
        "special.chebyshev_polynomial_t", ""
    ),  # aten.special_chebyshev_polynomial_t.default - couldn't find symbolic me...
    xfail(
        "special.chebyshev_polynomial_u", ""
    ),  # aten.special_chebyshev_polynomial_u.default - couldn't find symbolic me...
    xfail(
        "special.hermite_polynomial_h", ""
    ),  # aten.special_hermite_polynomial_h.default - couldn't find symbolic meta f...
    xfail(
        "special.hermite_polynomial_he", ""
    ),  # aten.special_hermite_polynomial_he.default - couldn't find symbolic meta...
    xfail(
        "special.laguerre_polynomial_l", ""
    ),  # aten.special_laguerre_polynomial_l.default - couldn't find symbolic meta...
    xfail(
        "special.modified_bessel_i0", ""
    ),  # aten.special_modified_bessel_i0.default - couldn't find symbolic meta funct...
    xfail(
        "special.modified_bessel_i1", ""
    ),  # aten.special_modified_bessel_i1.default - couldn't find symbolic meta funct...
    xfail(
        "special.modified_bessel_k0", ""
    ),  # aten.special_modified_bessel_k0.default - couldn't find symbolic meta funct...
    xfail(
        "special.modified_bessel_k1", ""
    ),  # aten.special_modified_bessel_k1.default - couldn't find symbolic meta funct...
    xfail(
        "special.polygamma", "special_polygamma_n_0"
    ),  # aten.polygamma.default - couldn't find symbolic meta function/...
    xfail(
        "special.scaled_modified_bessel_k0", ""
    ),  # aten.special_scaled_modified_bessel_k0.default - couldn't find symbo...
    xfail(
        "special.scaled_modified_bessel_k1", ""
    ),  # aten.special_scaled_modified_bessel_k1.default - couldn't find symbo...
    xfail(
        "stft", ""
    ),  # argument 'size' must be tuple of ints, but found element of type torch._C.SymIntNode at...
    xfail(
        "svd_lowrank", ""
    ),  # aten.mm.default - couldn't find symbolic meta function/decomposition
    ...
    xfail(
        "triangular_solve", ""
    ),  # aten.triangular_solve.default - couldn't find symbolic meta function/decomposition
    xfail(
        "vsplit", ""
    ),  # aten.size.default - couldn't find symbolic meta function/decomposition
    xfail(
        "unique_consecutive", ""
    ),  # aten.unique_consecutive.default - couldn't find symbolic meta function/decomposition
    xfail(
        "unique", ""
    ),  # aten._unique2.default - couldn't find symbolic meta function/decomposition
}
...
outplace_symbolic_tensor_failures = {
    xfail(
        "i0", ""
    ),  # aten.i0.default - couldn't find symbolic meta function/decomposition
    xfail(
        "masked_scatter", ""
    ),  # aten.masked_scatter.default - couldn't find symbolic meta function/decomposition
    xfail(
        "nn.functional.rrelu", ""
    ),  # aten.empty_like.default - couldn't find symbolic meta function/decomposition
}
...
def _test_make_fx_helper(self, device, dtype, op, tracing_mode, inplace=False):
    ...
    for sample_input in itertools.islice(sample_inputs_itr, 100):
        ...
        try:
            new_f = make_fx(f, tracing_mode=tracing_mode)(
                args, kwargs, extra_args, extra_kwargs
            )
...
class TestProxyTensorOpInfo(TestCase):
    ...
    @skipOps(
        ...
        make_fx_failures.union(fake_tensor_failures),
    )
