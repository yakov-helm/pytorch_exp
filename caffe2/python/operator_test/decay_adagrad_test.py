...
class TestDecayAdagrad(hu.HypothesisTestCase):
    ...
    def test_decay_adagrad(
        self, inputs, ITER, LR, beta1, beta2, epsilon, weight_decay, gc, dc
    ):
        ...
        op = core.CreateOperator(
            ...
            bias_correction_first=bias_correction_first,
        )
