...
class ReservoirSampling(ModelLayer):
    ...
    def __init__(
        self, model, input_record, num_to_collect, name="reservoir_sampling", **kwargs
    ):
        ...
        self.output_schema = schema.Struct(
            ("reservoir", schema.from_blob_list(input_record.data, [self.reservoir])),
