...
def Train(args):
    ...
    data_parallel_model.Parallelize(
        ...
        if args.model == "resnext"
        else create_shufflenet_model_ops,
...
def main():
    ...
    parser.add_argument(
        "--resnext_num_groups", type=int, default=1, help="The cardinality of resnext"
    )
    parser.add_argument(
        "--resnext_width_per_group",
        type=int,
        default=64,
    ...
    parser.add_argument(
        "--image_mean_per_channel",
        type=float,
        nargs="+",
        help="The per channel mean for the images",
    )
    parser.add_argument(
        "--image_std_per_channel",
        type=float,
        nargs="+",
        help="The per channel standard deviation for the images",
    )
    parser.add_argument(
        "--test_epoch_size", type=int, default=50000, help="Number of test images"
    )
    parser.add_argument(
        "--db_type",
        type=str,
    ...
    parser.add_argument(
        "--gpus", type=str, help="Comma separated list of GPU devices to use"
    )
    parser.add_argument(
        "--num_gpus",
        type=int,
    ...
    parser.add_argument(
        "--num_channels", type=int, default=3, help="Number of color channels"
    )
    parser.add_argument(
        "--image_size", type=int, default=224, help="Input image size (to crop to)"
    )
    parser.add_argument("--num_labels", type=int, default=1000, help="Number of labels")
    parser.add_argument(
        "--batch_size", type=int, default=32, help="Batch size, total over all GPUs"
    )
    parser.add_argument(
        "--epoch_size",
        type=int,
    ...
    parser.add_argument(
        "--base_learning_rate", type=float, default=0.1, help="Initial learning rate."
    )
    parser.add_argument(
        "--weight_decay",
        type=float,
    ...
    parser.add_argument(
        "--redis_host", type=str, help="Host of Redis server (for rendezvous)"
    )
    parser.add_argument(
        "--redis_port",
        type=int,
    ...
    parser.add_argument(
        "--use_nccl", action="store_true", help="Use nccl for inter-GPU collectives"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1200,
        help="Timeout (secs) of the first iteration " "(default: %(default)s)",
    )
    parser.add_argument(
        "--timeout",
        type=int,
